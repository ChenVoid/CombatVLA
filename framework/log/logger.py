...
from framework.utils.encoding_utils import decode_base64
from framework.utils.string_utils import hash_text_sha256
...
def process_log_messages(work_dir):
    ...
    log_path = os.path.join(work_dir, "logs/framework.log")
