...
from framework.utils.gui_utils import (get_named_windows,
                                     get_screen_size,
                                     mouse_button_down,
                                     mouse_button_up,
                                     mouse_button_down_hold,
                                     mouse_button_up_hold,
                                     key_down,
                                     key_up,
                                     mouse_click,
                                     get_mouse_location,
...
class IOEnvironment(metaclass=Singleton):
    ...
    def _mouse_button_down_hold(self, button, duration):
        mouse_button_down_hold(button, duration)

    def _mouse_button_up_hold(self, button):
        mouse_button_up_hold(button)
    ...
    def mouse_hold(self, button, duration = None):
        ...
        if duration is None:
            ...
            self._mouse_button_down_hold(button, duration)
            self._mouse_button_up_hold(button)
