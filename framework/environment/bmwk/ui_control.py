...
from framework.utils.template_matching import match_template_image
from framework import constants
from framework.environment import UIControl
...
class BMWKUIControl(UIControl):
    ...
    def is_env_paused(self) -> bool:
        ...
        pause_camera_template_file = f'./res/{config.env_sub_path}/icons/camera.png'

        screenshot = self.take_screenshot(time.time())
        match_info = match_template_image(screenshot, pause_camera_template_file, debug=True, output_bb=True,
